...
SELECT 
    ...
    u.email,
    CASE
      WHEN u.raw_user_meta_data->>'role' = 'complianceOfficer' THEN 'complianceOfficer'::user_role
      WHEN u.raw_user_meta_data->>'role' = 'admin' THEN 'admin'::user_role
      WHEN u.raw_user_meta_data->>'role' = 'executive' THEN 'executive'::user_role
      WHEN u.raw_user_meta_data->>'role' = 'support' THEN 'support'::user_role
